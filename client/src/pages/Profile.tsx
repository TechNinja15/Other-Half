...
import { Edit2, Camera, Save, Ghost, User, GraduationCap, CheckCircle2, AlertTriangle, LogOut, ChevronDown, Settings, Lock } from 'lucide-react';
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    className="w-full bg-gray-900 border-2 border-gray-800 text-gray-500 px-4 py-3 rounded-xl outline-none appearance-none h-[52px] pr-10 text-sm cursor-not-allowed"
                  ...
                  <Lock className="absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-500 w-4 h-4 pointer-events-none" />
                </div>
                <p className="text-[10px] text-gray-500 mt-1">
                  To change your college, please contact support with your ID card.
                </p>
              </div>
